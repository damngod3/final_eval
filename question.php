...
if(isset($_POST['submit'])){
	...
	{
		$mysqli_query=$_POST['radio'.$question2id];
		mysqli_query($conn,"INSERT INTO `evaluation`(`stu_id`,`tech_id`,`sub_id`, `question2`, `eval_ans`,comments) VALUES ('$stu_id','$tech_id','$sub_id','$question2id','$eval_ans','$comment')") or die (mysqli_error($conn));
/*
if(isset($_POST['submit']))
{
...
// mysqli_close($connection);*/
     ...
     echo  $msg ='<script> alert ("Evaluation has been Successful ")</script>';
